...
// 2016-07-20
final class BankCard extends \Dfe\AllPay\Webhook {
	/**
	 * 2016-08-09
	 ...
	 * @return bool
	 */
	function isInstallment() {return !!$this->req('stage');}
	 ...
	 * @return string|null
	 */
	protected function typeLabelByCode($codeFirst, $codeLast) {return df_cc_s(
